# Host: 106.15.230.197  (Version: 5.5.61-log)
# Date: 2019-05-16 10:29:45
...
CREATE TABLE `cmf_asset` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='资源表';

#
# Data for table "cmf_asset"
#

INSERT INTO `cmf_asset` VALUES (31,1,26536,1557885334,1,0,'a29673bf759e1b375e1e53e6687d05aae5710cb668ec84590fe5b36faa824641','prize1.jpg','admin/20190515/8a4f42b6f578daa21675eb5f2867873e.jpg','a29673bf759e1b375e1e53e6687d05aa','7abee0318ef1becd6fdf7bdd8a68d98085860a58','jpg',NULL),(32,1,27428,1557885350,1,0,'2917f71cbc27f55709cb99fb57e938866e9885a6c6f804d252b689804e60a270','prize6.jpg','admin/20190515/56db13a113de086b65abba2e3882b70e.jpg','2917f71cbc27f55709cb99fb57e93886','dd722868d9bb6142eab50a2f51c7d1636f724f1f','jpg',NULL),(33,1,687946,1557885403,1,0,'c97487bf82e571061b519a439755e4d603a734d1c69c8905a5c0b006b3483cdd','prize3.jpg','admin/20190515/853d447d3782be7a4f91092314554026.jpg','c97487bf82e571061b519a439755e4d6','8004fa6ac9b61413c04b209e5ce1d29d21c4547d','jpg',NULL),(34,1,22418,1557885421,1,0,'b7b87c0148c5c96184ca5c5c375a7906bb9b517051409c2af4b08c828316fa49','prize5.jpg','admin/20190515/e460b6cd40181cac68fad5257f12727e.jpg','b7b87c0148c5c96184ca5c5c375a7906','f4ade0ccc181f6a53432c4da5cbf3dcb94467ae0','jpg',NULL),(35,1,25842,1557885440,1,0,'9852963310259b6a13ad0a05377c0453fa7f59de1cbe500e8f48cc4bdf6561da','prize4.jpg','admin/20190515/0601dcea813665dfa5dd84263d380927.jpg','9852963310259b6a13ad0a05377c0453','67f35d9420c41e4b53d5fb11882bb646f2de3236','jpg',NULL),(36,1,28477,1557885452,1,0,'a94022d1b2dca60cb1be0d688172b847632bf5e336de800ac5002abeada15ba5','prize2.jpg','admin/20190515/ef1e52a90c4c4d459592e8bffb339be4.jpg','a94022d1b2dca60cb1be0d688172b847','d6f04d8de524653e0af43b2346c47d20bf11d417','jpg',NULL);
...
#
# Structure for table "cmf_prize"
#

DROP TABLE IF EXISTS `cmf_prize`;
CREATE TABLE `cmf_prize` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) DEFAULT NULL COMMENT '客户id',
  `shop_id` varchar(255) DEFAULT NULL COMMENT '奖品id',
  `status` varchar(255) DEFAULT NULL COMMENT '状态',
  `time` varchar(255) DEFAULT NULL COMMENT '时间',
  `xxtime` varchar(255) DEFAULT NULL,
  `dhtime` varchar(255) DEFAULT NULL COMMENT '兑换时间',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=239 DEFAULT CHARSET=utf8mb4;

#
# Data for table "cmf_prize"
#

/*!40000 ALTER TABLE `cmf_prize` DISABLE KEYS */;
INSERT INTO `cmf_prize` VALUES (235,231,'4','0','2019-05-15','2019-05-15 16:35:03',NULL),(236,232,'4','0','2019-05-15','2019-05-15 16:56:58',NULL),(237,240,'2','0','2019-05-16','2019-05-16 07:28:49',NULL),(238,241,'1','0','2019-05-16','2019-05-16 08:48:32',NULL);
/*!40000 ALTER TABLE `cmf_prize` ENABLE KEYS */;
...
#
# Structure for table "cmf_shop"
#

DROP TABLE IF EXISTS `cmf_shop`;
CREATE TABLE `cmf_shop` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `winrate` int(11) DEFAULT NULL COMMENT '胜率',
  `shopname` varchar(100) DEFAULT NULL COMMENT '商品名称',
  `image` varchar(255) DEFAULT NULL COMMENT '图片地址',
  `coding` varchar(255) DEFAULT NULL COMMENT '兑换编码',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='商品菜单表';

#
# Data for table "cmf_shop"
#

/*!40000 ALTER TABLE `cmf_shop` DISABLE KEYS */;
INSERT INTO `cmf_shop` VALUES (1,30,'手持风扇','/upload/admin/20190515/0601dcea813665dfa5dd84263d380927.jpg','ShouChiDhl'),(2,20,'毛巾','/upload/admin/20190515/e460b6cd40181cac68fad5257f12727e.jpg','MaoJinDhls2'),(3,15,'笔记本','/upload/admin/20190515/8a4f42b6f578daa21675eb5f2867873e.jpg','BiJiBenDhls3'),(4,15,'收纳袋','/upload/admin/20190515/56db13a113de086b65abba2e3882b70e.jpg','ShounadaiDhls4'),(5,20,'矿泉水','/upload/admin/20190515/853d447d3782be7a4f91092314554026.jpg','KuanquanshuiDhls5'),(6,0,'茶具套装','/upload/admin/20190515/ef1e52a90c4c4d459592e8bffb339be4.jpg','ChaJIDhls1');
/*!40000 ALTER TABLE `cmf_shop` ENABLE KEYS */;
...
#
# Structure for table "cmf_sms"
#

DROP TABLE IF EXISTS `cmf_sms`;
CREATE TABLE `cmf_sms` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "cmf_sms"
#

INSERT INTO `cmf_sms` VALUES (129,'18262211971','191291','2019-05-13 17:34:41'),(161,'16666666666','438613','2019-05-14 12:05:09'),(168,'17906199478','868069','2019-05-14 13:43:10'),(195,'18337152380','265191','2019-05-15 11:54:07'),(202,'15234133326','222076','2019-05-15 13:03:30'),(203,'15234133326','516227','2019-05-15 13:03:40'),(208,'15217702428','954685','2019-05-15 14:06:35');
...
INSERT INTO `cmf_user` VALUES (1,1,0,0,1557885264,0,0,0.00,1557134991,1,'admin','###caae1489f6372c40ca94ea21726a97a8','admin','123123@qq.com','','','','103.214.85.218','','','');
...
INSERT INTO `cmf_user_token` VALUES (1,1,1572687027,1557135027,'d62cc4e5efb76fd81f2534b1dcf0cb64fb627e71eb50a6c98de88b419d3726db','web');

#
# Structure for table "cmf_userinfo"
#

DROP TABLE IF EXISTS `cmf_userinfo`;
CREATE TABLE `cmf_userinfo` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=168 DEFAULT CHARSET=utf8 COMMENT='完善信息';

#
# Data for table "cmf_userinfo"
#

INSERT INTO `cmf_userinfo` VALUES (1,'张昭','zhangzhao@163.com','上海智火','山东省临沂市莒南县','18521940531'),(135,'zhao','516@sad.asd','zhihuo','shanghai','18337152380');
...
CREATE TABLE `cmf_wxuser` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=243 DEFAULT CHARSET=utf8 COMMENT='微信用户';

#
# Data for table "cmf_wxuser"
#

INSERT INTO `cmf_wxuser` VALUES (231,'odeRt0ZPYQP3V76EXJrbYmcJw0f4','攻克己身，叫身服我',2,'zh_CN','南阳','河南','中国','http://thirdwx.qlogo.cn/mmopen/vi_32/QNAHBfJicZt8hT4GVj04KySRkNKmjz4NwkFicxK22phKvoM1xOibkfo4ibLFEC3EUsm91vU2VDkgMrlia4iaIecOs43A/132','吕平翠','2683905576@qq.com','海王星辰健康大药房','18576874438','广东省东莞市厚街镇大润发对面海王星辰药店'),(232,'odeRt0UoDnydb0ymnzp1EyACtPJE','Sunny_L',2,'zh_CN','静安','上海','中国','http://thirdwx.qlogo.cn/mmopen/vi_32/icP38MGy8avXQ9B1n32QISsLBaySnVEgVVu7bYNZasdK1lbu7qp6BJIShE2ibY9K5X272TjNic1Waic0xia1Lic4ibzgw/132','刘海燕','hyliu@sh-industryexpo.com','上海工业商务展览有限公司','13817044030','五矿大厦'),(233,'odeRt0SeudtM2V4gt19aDVBss9n8','Crown',1,'zh_CN','静安','上海','中国','http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83